...
/**
 * These class represent the choose event of Turret tripod, the second effect of Machine Gun
 */
public class TurretTripodChooseEv extends VisibleChooseEv{

    /**
     * @param attacker is the player that invoke the effect
     * @param valid is the list of the players that can be selected as a valid extra target
     * @param notselectable is the list of the players that can't be selected, in first position the attacker than the targets of the basic effect
