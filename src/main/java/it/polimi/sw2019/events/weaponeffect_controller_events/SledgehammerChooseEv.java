 ...
 */
public class SledgehammerChooseEv extends VisibleChooseEv{
     ...
     */
    public SledgehammerChooseEv(String attacker, ArrayList<String> valid, ArrayList<String> notreachable) {
