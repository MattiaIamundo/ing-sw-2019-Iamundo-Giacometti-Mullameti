 ...
 */
public class SledgehammerChooseEv implements WeaponEvent{
     ...
     */
    public SledgehammerChooseEv(Player attacker, ArrayList<String> valid, ArrayList<String> notreachable) {
