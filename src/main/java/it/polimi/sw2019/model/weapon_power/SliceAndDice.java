...
public class SliceAndDice implements Power{
    ...
    private TwoDamageSameSpace basiceffect;
        ...
        while (true){
            try {
                ...
                if (e.getCode() == ErrorCode.ATTACKERSELECTED){
                    ...
                    System.out.println("You can't select "+e.getMessage()+" because he's the target of the basic effect\n");
                }
    ...
    private void initialize(Player attacker){
        ...
        basiceffect = (TwoDamageSameSpace) attacker.listWeapon()[i].getPower();
    }
     ...
     * @throws IllegalPlayerException caused by selecting as target the attacker or the target of the basic effect of the weapon
    ...
    private void acquireTarget(Player attacker) throws InvalidPlayerException, IllegalPlayerException, UnreachablePlayerException{
        ...
        int i = 0;
        String name;
        System.out.println("Insert the nickname of a player on your square, it must be different from the target of the basic effect");
