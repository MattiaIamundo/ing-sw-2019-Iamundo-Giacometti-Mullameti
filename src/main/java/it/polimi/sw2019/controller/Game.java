...
import it.polimi.sw2019.events.*;
 ...
 */
    ...
    public void update(PaymentInvalidEv paymentInvalidEv){
        PlayerRemoteView playerRemoteView = searchSpecificPlayerRemoteView( paymentInvalidEv.getNickname());
        if(playerRemoteView != null) {
            playerRemoteView.sendEvent( paymentInvalidEv );
        }
    }
